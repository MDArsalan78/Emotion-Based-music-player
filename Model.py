...
fishface=cv2.face.FisherFaceRecognizer_create() data={}
def update(emotions):
run_recognizer(emotions) print("Saving
model...") fishface.save("model2.xml")
print("Model saved!!")
...
def run_recognizer(emotions): training_data,
training_label=make_sets(emotions)
